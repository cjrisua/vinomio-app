...
export class AllocationComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log(history.state)
      ...
      this.profile = history.state.profile.id
      this.allocation.get(this.profile)
      .subscribe(results => { 
        this.allocations = results;
      });
      this.merchantService.get(this.profile)
  ...
  addNewComponent(event:any,data:any){
    ...
    let childComponent = this.componentFactoryResolver.resolveComponentFactory(AllocationEventComponent);
