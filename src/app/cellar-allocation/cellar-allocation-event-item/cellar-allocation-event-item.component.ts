...
@Component({
  selector: 'app-cellar-allocation-event-item',
  templateUrl: './cellar-allocation-event-item.component.html',
  styleUrls: ['./cellar-allocation-event-item.component.css']
})
export class CellarAllocationEventItemComponent implements OnInit {
